...
object SuiTypeMapperFunction {
  ...
  def apply(compName: CompName, name: PropName): String =
    (compName.value, name.value) match {
      ...
      case ("Dropdown", "onChange") => "(ReactEventFromInput, SuiChangeObject) => Callback"
      ...
      case ("Input", "onChange") => "(ReactEventFromInput, SuiChangeObject) => Callback"
      case ("Checkbox", "onChange") => "(ReactEventFromInput, SuiCheckboxChangeObject) => Callback"
      case ("TextArea", "onChange") => "(ReactEventFromInput, SuiChangeObject) => Callback"
      ...
      case (_, "onAddItem") => "(ReactEventFromInput, SuiChangeObject) => Callback"
      case (_, "onBlur") => "(ReactEventFromInput, SuiChangeObject) => Callback"
      case (_, "onClose") => "ReactEvent => Callback" //TODO more specific?
      case (_, "onFocus") => "ReactEvent => Callback" //TODO more specific?
      case (_, "onLabelClick") => "(ReactEventFromInput, SuiChangeObject) => Callback"
      case (_, "onOpen") => "(ReactEventFromInput, SuiChangeObject) => Callback"
      case (_, "onSearchChange") => "(ReactEventFromInput, SuiSearchChangeObject) => Callback"
